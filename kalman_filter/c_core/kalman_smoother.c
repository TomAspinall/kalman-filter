    ...
    double *Vt_output)
{
    ...
    scipy_cblas_dcopy64_(blas_m * blas_n, xtt, intone, xhatt_output, intone);
    scipy_cblas_dcopy64_(blas_m * blas_m * blas_n, Ptt, intone, Vt_output, intone);
    ...
    while (t > -1)
    {
        ...
        scipy_cblas_dcopy64_(blas_m, r, intone, tmpr, intone);
        ...
        for (int SP = d - 1; SP > -1; SP--)
        {
            ...
            // Step 1: L = I_m
            scipy_cblas_dcopy64_(m_x_m, identity_matrix, intone, L, intone);
